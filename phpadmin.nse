...
---
-- @hackyseguridad
-- nmap -p <port> --script phpmyadmin <target>
--
...
action = function(host, port)
 ...
 local url = stdnse.get_script_args(SCRIPT_NAME..".url") or "/phpmyadmin/index.php"
 local response = http.generic_request(host, port, "GET", "/phpmyadmin/index.php" , options)
