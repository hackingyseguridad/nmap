...
action = function(host, port)
 ...
 local url = stdnse.get_script_args(SCRIPT_NAME..".url") or "/Citrix/MetaFrame/auth/login.aspx"
 local response = http.generic_request(host, port, "GET", "/Citrix/MetaFrame/auth/login.aspx", options)
