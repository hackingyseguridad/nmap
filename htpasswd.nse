...
action = function(host, port)
  local vuln = {
    title = "Detecta el fichero expuesto en: /int/private/.htpasswd",
    ...
    dates = {
        disclosure = { year = '2022', month = '10', day = '04' }
    }
  }
 ...
 local url = stdnse.get_script_args(SCRIPT_NAME..".url") or "/int/private/.htpasswd"
 local response = http.generic_request(host, port, "GET", "/int/private/.htpasswd", options)
